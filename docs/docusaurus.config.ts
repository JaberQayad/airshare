...
const config: Config = {
  ...
  projectName: 'airshare', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/jaberio/airshare/tree/main/docs/',
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/jaberio/airshare/issues',
            },
            {
              label: 'GitHub Discussions',
              href: 'https://github.com/jaberio/airshare/discussions',
            },
          ],
        },
        {
